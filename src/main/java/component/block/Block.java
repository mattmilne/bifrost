...
public abstract class Block extends Component {
    ...
    @Override
    public void beginCollision(GameObject collisionObject, Contact contact, Vector2f contactNormal) {
        PlayerController playerController = collisionObject.getComponent(PlayerController.class);
